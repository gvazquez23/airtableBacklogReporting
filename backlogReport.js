//add this into a scripting block extension on the Airtable base
...
async function runReport() {
    ...
    //this makes it so you can surface a graph  on the dashboard if you'd like
    ...
    const renamedArray = openTicketsByMonth.map(obj => {
        const {date, count} = obj;
        const Date = date; 
        const BacklogSize = count; 
        return { Date, BacklogSize}; 
    });
